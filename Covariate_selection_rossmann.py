...
# for Store in [100]:
    ...
    for v in variables:
        ...
        pipeline = Chronos2Pipeline.from_pretrained("amazon/chronos-2", device_map="cuda:1")

        y_pred = Chronos2_forecasting(pipeline, sales, df_sub[v].tolist(), "Sales", len(df_sub), train_end)
